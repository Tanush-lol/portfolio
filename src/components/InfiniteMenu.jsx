    ...
    <div className="relative w-full h-full">
      ...
      {activeItem && (
        <>
          <h2
            className={`
          text-white  font-medium drop-shadow-[0_5.2px_0_theme(colors.black)]
          select-none
          absolute
          font-black
          [font-size:4rem]
        ...
        `}><span className='text-white text-xl font-medium drop-shadow-[0_2.0px_0_theme(colors.black)]'>Click</span> 
            <p className="select-none text-white relative text-[#060010] top-[2px] text-[26px]"> &#x2197;</p>
          </div>
        </>
      )}
    </div>
